...
if(isset($_POST['login']))
{
    ...
    $sql_check = mysqli_query($mysqli,"select * from nguoidung where username = '$username'");
    ...
    {
        $sql_check2 = mysqli_query($mysqli,"select * from nguoidung where username = '$username' and password = '$password'");
