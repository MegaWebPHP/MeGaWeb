...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($mysqli,"SELECT * FROM tintuc order by matt DESC LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			$total_results = mysqli_result(mysql_query($mysqli,"SELECT COUNT(*) as Num FROM tintuc"),0);  
