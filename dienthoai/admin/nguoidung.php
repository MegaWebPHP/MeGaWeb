...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($mysqli,"SELECT * FROM nguoidung LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			// $total_results = mysqli_result(mysqli_query($mysqli,"SELECT COUNT(*) as Num FROM nguoidung"),0);  
