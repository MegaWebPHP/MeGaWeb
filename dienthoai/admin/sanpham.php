...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($mysqli,"SELECT * FROM sanpham inner join danhmuc on sanpham.madm=danhmuc.madm ORDER by idsp DESC  LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			$result = mysqli_query($mysqli,"SELECT COUNT(*) as Num FROM sanpham");
