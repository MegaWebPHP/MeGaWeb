...
<table>
	...
	/*------------Phan trang------------- */
		...
		$sql = mysqli_query($mysqli,"SELECT * FROM hoadon ORDER by mahd DESC  LIMIT $from, $max_results"); 
...
?>
	...
	<?php
			...
			//$total_results = mysqli_result(mysqli_query($mysqli,"SELECT COUNT(*) as Num FROM hoadon"),0);  
			$result = mysqli_query($mysqli,"SELECT COUNT(*) as Num FROM hoadon");
